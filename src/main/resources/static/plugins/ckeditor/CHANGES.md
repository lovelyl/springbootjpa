...
* [#13337](http://dev.ckeditor.com/ticket/13337): Added the [`jpa.repository.onWidget()`](http://docs.ckeditor.com/#!/api/CKEDITOR.plugins.widget.jpa.repository-method-onWidget) method &mdash; a convenient way to listen to [widget](http://docs.ckeditor.com/#!/api/CKEDITOR.plugins.widget) events through the [jpa.repository](http://docs.ckeditor.com/#!/api/CKEDITOR.plugins.widget.jpa.repository).
...
* [#12296](http://dev.ckeditor.com/ticket/12296): Merged `benderjs-ckeditor` into the main CKEditor jpa.repository.
...
* [#11983](http://dev.ckeditor.com/ticket/11983): Fixed: Clicking a nested widget does not focus it. Additionally, performance of the [`widget.jpa.repository.getByElement()`](http://docs.ckeditor.com/#!/api/CKEDITOR.plugins.widget.jpa.repository-method-getByElement) method was improved.
...
* [#11186](http://dev.ckeditor.com/ticket/11186): Introduced the [`widgets.jpa.repository.addUpcastCallback()`](http://docs.ckeditor.com/#!/api/CKEDITOR.plugins.widget.jpa.repository-method-addUpcastCallback) method that allows to block upcasting given element to a widget.
...
* [#11244](http://dev.ckeditor.com/ticket/11244): Changed: The [`widget.jpa.repository.checkWidgets()`](http://docs.ckeditor.com/#!/api/CKEDITOR.plugins.widget.jpa.repository-method-checkWidgets) method now fires the [`widget.jpa.repository.checkWidgets`](http://docs.ckeditor.com/#!/api/CKEDITOR.plugins.widget.jpa.repository-event-checkWidgets) event, so from CKEditor 4.3.1 it is preferred to use the method rather than fire the event.
* [#11171](http://dev.ckeditor.com/ticket/11171): Fixed: [`editor.insertElement()`](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-method-insertElement) and [`editor.insertText()`](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-method-insertText) methods do not call the [`widget.jpa.repository.checkWidgets()`](http://docs.ckeditor.com/#!/api/CKEDITOR.plugins.widget.jpa.repository-method-checkWidgets) method.
